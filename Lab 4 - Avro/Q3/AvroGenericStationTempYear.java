...
public class AvroGenericStationTempYear extends Configured implements Tool
{
	...
	public static class AvroReducer extends Reducer<AvroKey<GenericRecord>, NullWritable, AvroKey<GenericRecord>, NullWritable>
	{
				...
				Context context) throws IOException, InterruptedException
		{
			...
			AvroKey<GenericRecord> MaxTempKey = new AvroKey<GenericRecord>(genericRecord);
			...
			for(NullWritable value: values){
				...
				if(isFirst||(maxTemp<temp)){
					isFirst=false;
					genericRecord.put("stationId", record.get("stationId"));
					genericRecord.put("temperature", record.get("temperature"));
					genericRecord.put("year", record.get("year"));
					maxTemp = (float) (genericRecord.get("temperature"));
				}
			}
		...
		/*public static GenericRecord newWeatherRecord(GenericRecord record){
